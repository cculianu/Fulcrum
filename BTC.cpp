...
namespace BTC
{
    ...
    namespace Tests {
        ...
        void TestBlock()
        {
            ...
            /*
            auto v = bitcoin::ParseHex( "0100000050120119172a610421a6c3011dd330d9df07b63616c2cc1f1cd00200000000"
            ...
            bitcoin::CDataStream cd(reinterpret_cast<char *>(&v.front()),
                                    reinterpret_cast<char *>(&v.back())+1,
                                    bitcoin::SER_NETWORK,
